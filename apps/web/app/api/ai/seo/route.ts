...
Задача: сгенерируй SEO-метаданные для категории товаров.

Категория: ${fullPath}

ТРЕБОВАНИЯ:
1. Найди в интернете актуальное семантическое ядро для этой категории товаров в Нижнем Новгороде
2. seoTitle — до 60 символов, включи основной ключевой запрос + гео «Нижний Новгород» или «в Нижнем Новгороде». Формат: «[Товар] купить в Нижнем Новгороде | Простор»
3. seoDescription — 140-160 символов, включи 2-3 ключевых запроса из ядра, УТП (цены, гарантия, trade-in), призыв к действию, гео-привязку
4. seoKeywords — массив из 8-12 ключевых фраз из семантического ядра, от ВЧ к НЧ, все с гео-привязкой к Нижнему Новгороду где уместно
