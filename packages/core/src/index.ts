...
const rolePermissions: Record<AdminRole, Record<AdminAction, AdminResource[]>> = {
  ...
  manager: {
    read: [...adminResources],
    write: ["products", "categories", "banners", "clients", "orders", "trade-in", "service", "telegram-posts", "marketing", "promo-codes"],
    delete: ["products", "categories", "banners", "trade-in", "promo-codes"],
  },
  editor: {
    read: ["products", "categories", "banners", "clients", "orders", "trade-in", "service", "activity", "promo-codes"],
